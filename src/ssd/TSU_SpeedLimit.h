...
namespace SSD_Components
{
	...
	private:
		...
		double* slowdown;
		unsigned long*** remain_in_queue_count;
		...
		void estimate_alone_time(NVM_Transaction_Flash* transaction, Flash_Transaction_Queue* buffer, Flash_Transaction_Queue* queue);
